...
public class WorldBorder implements SupportedWorldBorder {
	...
	private net.minecraft.server.v1_11_R1.WorldBorder	border;
	...
	public WorldBorder(Player player){
		try {
			this.border = net.minecraft.server.v1_11_R1.WorldBorder.class.newInstance();
	...
	public net.minecraft.server.v1_11_R1.WorldBorder getHandle() {
		return border;
	}
