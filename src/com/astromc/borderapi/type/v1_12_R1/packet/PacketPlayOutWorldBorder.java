package com.astromc.borderapi.type.v1_12_R1.packet;

import com.astromc.borderapi.type.v1_12_R1.world.WorldBorder;
import com.astromc.borderapi.type.v1_12_R1.world.WorldBorderAction;
...
public class PacketPlayOutWorldBorder extends SupportedPacketPlayOutWorldBorder {
	...
	public PacketPlayOutWorldBorder(WorldBorder border, WorldBorderAction action) {
		super(new net.minecraft.server.v1_12_R1.PacketPlayOutWorldBorder(border.getHandle(), action.getHandle()));
	}
